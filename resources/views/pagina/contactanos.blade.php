        ...
        <div class="row g-4">
            ...
            <div class="col-md-6">
                <div class="wow fadeInUp" data-wow-delay="0.5s">
                    <p class="mb-4">Si desea solicitar más información o enviarnos un comentario, puede rellenar el siguiente formulario. Uno de nuestros asesores se pondrá en contacto con usted a la mayor brevedad posible para resolver sus dudas y ofrecerle toda la información que necesite.</p>
                    <form>
                        <div class="row g-3">
                            <div class="col-md-6">
